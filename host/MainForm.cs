...
public sealed partial class MainForm : Form
{
    ...
    private static string BuildLiveConfigText(JsonElement config)
    {
        ...
        AppendLine(builder, "drone_track_gain", GetDouble(config, "droneTrackGain", 1.15));
        AppendLine(builder, "drone_track_velocity_gain", GetDouble(config, "droneTrackVelocityGain", 0.18));
        AppendLine(builder, "drone_track_damping", GetDouble(config, "droneTrackDamping", 0.28));
        AppendLine(builder, "drone_track_smoothing", GetDouble(config, "droneTrackSmoothing", 0.55));
        AppendLine(builder, "drone_track_max_move", GetInt(config, "droneTrackMaxMove", 140));
        AppendLine(builder, "drone_track_deadzone", GetDouble(config, "droneTrackDeadzone", 0.8));
    ...
    private static void AddBackendArguments(ProcessStartInfo startInfo, string configJson)
    {
        ...
        AddArg(startInfo, "drone-track-gain", GetDouble(config, "droneTrackGain", 1.15));
        AddArg(startInfo, "drone-track-velocity-gain", GetDouble(config, "droneTrackVelocityGain", 0.18));
        AddArg(startInfo, "drone-track-damping", GetDouble(config, "droneTrackDamping", 0.28));
        AddArg(startInfo, "drone-track-smoothing", GetDouble(config, "droneTrackSmoothing", 0.55));
        AddArg(startInfo, "drone-track-max-move", GetInt(config, "droneTrackMaxMove", 140));
        AddArg(startInfo, "drone-track-deadzone", GetDouble(config, "droneTrackDeadzone", 0.8));
